    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="text-xl font-bold font-unbounded text-white mb-2 group-hover:text-[#BA170D]">
            USER MANAGEMENT
          </h3>
          <p className="text-sm text-gray-500">
            View registered users, manage roles, and export user data.
          </p>
        </button>
        ...
        >
          ...
          <p className="text-sm text-gray-500">
            Track event registrations, view participants, and download
        ...
        >
          ...
          <p className="text-sm text-gray-500">
            Enter event results, manage negative markings, and track the house
            leaderboard.
          </p>
        </button>
      </div>
